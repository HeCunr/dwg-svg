...
class Config(_Config):
    ...
    def __init__(self, num_gpus=1):
        ...
        self.max_num_groups = 60#8->3000
        self.max_total_len = 120#50->9000000
        ...
        self.batch_size =60 * num_gpus     #60 * num_gpus ->1
        self.grad_clip = 1.0
    ...
    def set_train_vars(self, train_vars, dataloader):
        train_vars.x_inputs_train = [dataloader.dataset.get(idx, [*self.model_args, "tensor_grouped"])
                                     for idx in random.sample(range(len(dataloader.dataset)), k=1)]#k=5->k=1
