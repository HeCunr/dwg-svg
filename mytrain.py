...
def train(cfg: _Config, model_name, experiment_name="", log_dir="./logs", debug=False, resume=False):
    ...
    if resume and ckpt_exists:
        ...
        single_foward_dataloader = DataLoader(dataset, batch_size=1, shuffle=True, drop_last=True,
                                              num_workers=cfg.loader_num_workers, collate_fn=cfg.collate_fn)
        ...
        #             dataset,
        #             batch_size=1,#cfg.batch_size // cfg.num_gpus->1
        #             shuffle=True,
        #             drop_last=True,
    ...
    final_model_path = r"C:\Users\15653\deepsvg\pretrained\my_pth\my.pth"
